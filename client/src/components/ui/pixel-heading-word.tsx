...
export interface PixelHeadingProps extends React.ComponentProps<"h1"> {
  ...
  showLabel?: boolean
  /**
   * Automatically cycle through fonts on mount without requiring hover.
   * @default false
   */
  autoPlay?: boolean
  /**
...
export function PixelHeading({
  ...
  /* ---- Auto-play (mount cycling) ---- */
  useEffect(() => {
    if (!autoPlay || isSwapMode) return
  ...
  }, [autoPlay, isSwapMode, advanceFont, cycleInterval])
