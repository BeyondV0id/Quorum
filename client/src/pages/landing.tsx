        ...
        <div className="rounded-md bg-card p-12 text-card-foreground shadow-xs">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="inline-flex h-9 w-full items-center justify-center gap-2 rounded-lg border border-border bg-card px-4 text-xs font-medium text-card-foreground transition hover:bg-muted"
            >
